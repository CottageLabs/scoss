...
$.extend(!0,edges,{bs3:{newTabularResultsRenderer:function(e){return e||(e={}),edges.bs3.TabularResultsRenderer.prototype=edges.newRenderer(e),new edges.bs3.TabularResultsRenderer(e)},TabularResultsRenderer:function(e){this.noResultsText=e.noResultsText||"No results to display",this.defaultCellContent=e.defaultCellContent||"-",this.fieldDisplay=e.fieldDisplay||[],this.displayListedOnly=edges.getParam(e.displayListedOnly,!0),this.headerOrderingFunction=edges.getParam(e.headerOrderingFunction,!1),this.download=edges.getParam(e.download,!1),this.downloadText=edges.getParam(e.downloadText,"download"),this.downloadPrefix=edges.getParam(e.downloadPrefix,"download"),this.namespace="edges-bs3-tabular-results",this.draw=function(){var e=this.noResultsText;this.component.results===!1&&(e="");var s=this.component.results;if(s&&s.length>0){var t=this._getHeaderRow(),a=edges.css_classes(this.namespace,"table",this),i=edges.css_classes(this.namespace,"header",this),l=edges.css_classes(this.namespace,"cell",this),d=edges.css_classes(this.namespace,"download",this),n=edges.css_classes(this.namespace,"tablediv",this),r=edges.css_id(this.namespace,"download",this),o="";this.download&&(o='<div class="row"><div class="col-md-12"><div class="'+d+'"><a href="#" id="'+r+'">'+edges.escapeHtml(this.downloadText)+"</a></div></div></div>");var e='<div class="table-responsive '+n+'">';e+='<table class="'+a+'"><thead><tr>_HEADERS_</tr></thead><tbody>';for(var h=[],c=0;c<t.length;c++){for(var g=!1,f=0;f<this.fieldDisplay.length;f++){var p=this._getFieldDisplay(t[c]);if(p){h.push(p.display),g=!0;break}}g||h.push(t[c])}for(var u="",c=0;c<h.length;c++){var v=h[c];u+='<th class="'+i+'">'+v+"</th>"}e=e.replace(/_HEADERS_/g,u);for(var c=0;c<s.length;c++){var y=s[c];e+="<tr>";for(var f=0;f<t.length;f++){var w=t[f],m=this.defaultCellContent,p=this._getFieldDisplay(w);p&&(m=p["default"]);var b=edges.objVal(w,y,m),_=edges.css_classes(this.namespace,"cell-"+edges.safeId(w),this);e+='<td class="'+l+" "+_+'">'+edges.escapeHtml(b)+"</td>"}e+="</tr>"}e+="</tbody></table></div>"+o}if(this.component.context.html(e),this.download){var D=edges.css_id_selector(this.namespace,"download",this);edges.on(D,"click",this,"doDownload")}},this.doDownload=function(e){if(this.download){var s=this._downloadData(),t=new Blob([s.data],{type:s.fileType}),a=window.URL.createObjectURL(t),i=document.createElement("a");document.body.appendChild(i),i.style="display: none",i.href=a,i.download=s.fileName,i.click(),window.URL.revokeObjectURL(a)}},this._downloadData=function(){if(!this.download)return!1;var e=[],s=this.component.results;if(s&&s.length>0){for(var t=this._getHeaderRow(),a=[],i=0;i<t.length;i++){for(var l=!1,d=0;d<this.fieldDisplay.length;d++){var n=this._getFieldDisplay(t[i]);if(n){a.push(n.display),l=!0;break}}l||a.push(t[i])}e.push(a);for(var i=0;i<s.length;i++){for(var r=s[i],o=[],d=0;d<t.length;d++){var h=t[d],c=edges.objVal(h,r,"");o.push(c)}e.push(o)}}var g=edges.csv.serialise({data:e}),f="text/csv;charset=UTF-8",p="csv",u=(new Date).getTime(),v=this.downloadPrefix+"_"+u+"."+p;return{data:g,fileType:f,fileName:v}},this._getFieldDisplay=function(e){for(var s=0;s<this.fieldDisplay.length;s++)if(this.fieldDisplay[s].field==e)return this.fieldDisplay[s];return!1},this._getHeaderRow=function(){if(this.headerOrderingFunction)return this.headerOrderingFunction(this);var e=this.component.results,s=e!==!1&&e.length>0;if(!s||0==this.fieldDisplay.length&&this.displayListedOnly)return[];var t=[];if(this.fieldDisplay.length>0)for(var a=0;a<this.fieldDisplay.length;a++)t.push(this.fieldDisplay[a].field);if(!this.displayListedOnly){for(var i={},a=0;a<e.length;a++)for(var l=Object.keys(e[a]),d=0;d<l.length;d++)l[d]in i||(i[l[d]]=!0);var n=Object.keys(i);n.sort();for(var a=0;a<n.length;a++)-1==$.inArray(n[a],t)&&t.push(n[a])}return t}}}});
var scoss={activeEdges:{},preprocessMasterSheet:function(e){var s=e.service_id;return function(e){var r=e.resource,t=e.edge;r.add_filter({filter:{field:"Service ID",value:s,type:"exact"}});var o=[edges.csv.newSumAggregation({name:"total_committed",field:"Funding Committed (EUR)"}),edges.csv.newSumAggregation({name:"total_paid",field:"Total Paid (EUR)"}),edges.csv.newTermsAggregation({name:"country",field:"Funder Country",nested:[edges.csv.newSumAggregation({name:"total_committed",field:"Funding Committed (EUR)"})]}),edges.csv.newTermsAggregation({name:"continent",field:"Funder Continent",nested:[edges.csv.newSumAggregation({name:"total_committed",field:"Funding Committed (EUR)"})]}),edges.csv.newTermsAggregation({name:"funders",field:"Funder Full Name",order:"term",nested:[edges.csv.newSumAggregation({name:"total_committed",field:"Funding Committed (EUR)"})]})];t.resources.master_aggregations=r.applyAggregations({aggs:o})}},preprocessServiceProviderSheet:function(e){var s=e.service_id;return function(e){var r=e.resource,t=e.edge;r.add_filter({filter:{field:"Service ID",value:s,type:"exact"}});var o=r.iterator();t.resources.service_provider=o.next()}},progressCommitted:function(e){var s=e.edge.resources.master_aggregations,r=s.total_committed,t=e.edge.resources.service_provider,o=edges.numParse(),i=r.sum,d=t["Funding Target (EUR)"];d=o(d);var a=0;return 0!==i&&(a=0),a=i/d*100,a>100&&(a=100),{pc:a,x:i,y:d}},progressPaid:function(e){var s=e.edge.resources.master_aggregations,r=s.total_paid,t=e.edge.resources.service_provider,o=edges.numParse(),i=r.sum,d=t["Funding Target (EUR)"];d=o(d);var a=0;return 0!==i&&(a=0),a=i/d*100,a>100&&(a=100),{pc:a,x:i,y:d}},progressNeeded:function(e){var s=scoss.progressCommitted(e),r=100-s.pc,t=s.y,o=t-s.x;return 0>o&&(o=0),{pc:r,x:o,y:t}},countryDF:function(e){function s(e,s){return s.value-e.value}for(var r=e.edge.resources.master_aggregations,t=r.country,o={key:"By Country",values:[]},i=0;i<t.buckets.length;i++){var d=t.buckets[i],a=d.term,n=d.aggs.total_committed.sum;o.values.push({label:a,value:n})}return o.values.sort(s),[o]},continentDF:function(e){for(var s=e.edge.resources.master_aggregations,r=s.continent,t={key:"By Continent",values:[]},o=0;o<r.buckets.length;o++){var i=r.buckets[o],d=i.term,a=i.aggs.total_committed.sum;t.values.push({label:d,value:a})}return[t]},topDonorsDFClosure:function(e){var s=e.limit;return function(e){function r(e,s){return s.value-e.value}for(var t=e.edge.resources.master_aggregations,o=t.funders,i={key:"Top Donors/Members",values:[]},d=0;d<o.buckets.length;d++){var a=o.buckets[d],n=a.term,c=a.aggs.total_committed.sum;i.values.push({label:n,value:c})}return i.values.sort(r),i.values=i.values.slice(0,s),[i]}},makeServiceProviderPage:function(e){scoss.activeEdges[e.selector]=edges.newEdge({selector:e.selector,template:scoss.newServiceProviderPageTemplate(),staticFiles:[{id:"service_registry",url:e.service_registry,processor:edges.csv.newObjectByRow,datatype:"text",opening:scoss.preprocessServiceProviderSheet({service_id:e.service_id})},{id:"master_data",url:e.master_data,processor:edges.csv.newObjectByRow,datatype:"text",opening:scoss.preprocessMasterSheet({service_id:e.service_id})}],components:[edges.loading.newLoadingBar({id:"progress_committed",calculate:scoss.progressCommitted,renderer:edges.loading_io.newLoadingIORendererBS3({preset:"circle",title:"Committed",showXofY:!0,xyNumFormat:edges.numFormat({prefix:"&euro;",thousandsSeparator:","})})}),edges.loading.newLoadingBar({id:"progress_paid",calculate:scoss.progressPaid,renderer:edges.loading_io.newLoadingIORendererBS3({preset:"circle",title:"Paid",showXofY:!0,xyNumFormat:edges.numFormat({prefix:"&euro;",thousandsSeparator:","})})}),edges.loading.newLoadingBar({id:"progress_needed",calculate:scoss.progressNeeded,renderer:edges.loading_io.newLoadingIORendererBS3({preset:"circle",title:"Needed",showXofY:!0,xyNumFormat:edges.numFormat({prefix:"&euro;",thousandsSeparator:","})})}),edges.newHorizontalMultibar({id:"by_country",dataFunction:scoss.countryDF,renderer:edges.nvd3.newHorizontalMultibarRenderer({dynamicHeight:!0,barHeight:15,reserveAbove:50,reserveBelow:50})}),edges.newPieChart({id:"by_continent",dataFunction:scoss.continentDF,renderer:edges.nvd3.newPieChartRenderer({valueFormat:d3.format(",d"),labelsOutside:!0,color:!1})}),edges.newHorizontalMultibar({id:"top_donors",dataFunction:scoss.topDonorsDFClosure({limit:e.top_donor_limit}),renderer:edges.nvd3.newHorizontalMultibarRenderer({dynamicHeight:!0,barHeight:15,reserveAbove:50,reserveBelow:50})}),scoss.newDonorList({id:"all_donors",renderer:edges.bs3.newTabularResultsRenderer({fieldDisplay:[{field:"donor",display:"Donor/Member"},{field:"committed",display:"Committed"}]})})]})},newServiceProviderPageTemplate:function(e){return edges.instantiate(scoss.ServiceProviderPageTemplate,e,edges.newTemplate)},ServiceProviderPageTemplate:function(e){this.namespace="scoss-spp",this.draw=function(e){this.edge=e;var s=edges.css_classes(this.namespace,"container"),r=edges.css_classes(this.namespace,"progress_committed"),t=edges.css_classes(this.namespace,"progress_paid"),o=edges.css_classes(this.namespace,"progress_needed"),i=edges.css_classes(this.namespace,"country"),d=edges.css_classes(this.namespace,"continent"),a=edges.css_classes(this.namespace,"top-donors"),n=edges.css_classes(this.namespace,"all-donors"),c='<div class="'+s+'">                    <div class="row">                        <div class="col-md-2 col-md-offset-3"><div id="progress_committed" class="'+r+'"></div></div>                        <div class="col-md-2"><div id="progress_paid" class="'+t+'"></div></div>                        <div class="col-md-2"><div id="progress_needed" class="'+o+'"></div></div>                    </div>                    <div class="row"><div class="col-md-12"><div id="by_country" class="'+i+'"></div></div></div>                    <div class="row"><div class="col-md-12"><div id="by_continent" class="'+d+'"></div></div></div>                    <div class="row"><div class="col-md-12"><div id="top_donors" class="'+a+'"></div></div></div>                    <div class="row"><div class="col-md-12"><div id="all_donors" class="'+n+'"></div></div></div>                </div></div>';e.context.html(c)}},newDonorList:function(e){return edges.instantiate(scoss.DonorList,e,edges.newComponent)},DonorList:function(e){this.results=[],this.synchronise=function(){this.results=[];for(var e=this.edge.resources.master_aggregations.funders,s=0;s<e.buckets.length;s++){var r=e.buckets[s];this.results.push({donor:r.term,committed:r.aggs.total_committed.sum})}}}};
