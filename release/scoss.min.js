...
var scoss={activeEdges:{},preprocessMasterSheet:function(e){var s=e.service_id;return function(e){var r=e.resource,i=e.edge;r.add_filter({filter:{field:"Service ID",value:s,type:"exact"}});var d=[edges.csv.newSumAggregation({name:"total_committed",field:"Funding Committed (EUR)"}),edges.csv.newSumAggregation({name:"total_paid",field:"Total Paid (EUR)"}),edges.csv.newTermsAggregation({name:"continent",field:"Funder Continent",nested:[edges.csv.newSumAggregation({name:"total_committed",field:"Funding Committed (EUR)"})]})];i.resources.master_aggregations=r.applyAggregations({aggs:d})}},preprocessServiceProviderSheet:function(e){var s=e.service_id;return function(e){var r=e.resource,i=e.edge;r.add_filter({filter:{field:"Service ID",value:s,type:"exact"}});var d=r.iterator();i.resources.service_provider=d.next()}},progressCommitted:function(e){for(var s=!1,r=e.edge.resources.master_aggregations,i=0;i<r.length;i++)if("total_committed"===r[i].name){s=r[i];break}var d=e.edge.resources.service_provider,a=edges.numParse(),t=s.sum,o=d["Funding Target (EUR)"];o=a(o);var n=0;return 0!==t&&(n=0),n=t/o*100,n>100&&(n=100),{pc:n,x:t,y:o}},progressPaid:function(e){for(var s=!1,r=e.edge.resources.master_aggregations,i=0;i<r.length;i++)if("total_paid"===r[i].name){s=r[i];break}var d=e.edge.resources.service_provider,a=edges.numParse(),t=s.sum,o=d["Funding Target (EUR)"];o=a(o);var n=0;return 0!==t&&(n=0),n=t/o*100,n>100&&(n=100),{pc:n,x:t,y:o}},progressNeeded:function(e){var s=scoss.progressCommitted(e),r=100-s.pc,i=s.y,d=i-s.x;return 0>d&&(d=0),{pc:r,x:d,y:i}},continentDF:function(e){for(var s=!1,r=e.edge.resources.master_aggregations,i=0;i<r.length;i++)if("continent"===r[i].name){s=r[i];break}for(var d={key:"By Continent",values:[]},i=0;i<s.terms.length;i++){var a=s.terms[i],t=a.term,o=a.aggs[0].sum;d.values.push({label:t,value:o})}return[d]},makeServiceProviderPage:function(e){scoss.activeEdges[e.selector]=edges.newEdge({selector:e.selector,template:scoss.newServiceProviderPageTemplate(),staticFiles:[{id:"service_registry",url:e.service_registry,processor:edges.csv.newObjectByRow,datatype:"text",opening:scoss.preprocessServiceProviderSheet({service_id:e.service_id})},{id:"master_data",url:e.master_data,processor:edges.csv.newObjectByRow,datatype:"text",opening:scoss.preprocessMasterSheet({service_id:e.service_id})}],components:[edges.loading.newLoadingBar({id:"progress_committed",calculate:scoss.progressCommitted,renderer:edges.loading_io.newLoadingIORendererBS3({preset:"circle",title:"Committed",showXofY:!0,xyNumFormat:edges.numFormat({prefix:"&euro;",thousandsSeparator:","})})}),edges.loading.newLoadingBar({id:"progress_paid",calculate:scoss.progressPaid,renderer:edges.loading_io.newLoadingIORendererBS3({preset:"circle",title:"Paid",showXofY:!0,xyNumFormat:edges.numFormat({prefix:"&euro;",thousandsSeparator:","})})}),edges.loading.newLoadingBar({id:"progress_needed",calculate:scoss.progressNeeded,renderer:edges.loading_io.newLoadingIORendererBS3({preset:"circle",title:"Needed",showXofY:!0,xyNumFormat:edges.numFormat({prefix:"&euro;",thousandsSeparator:","})})}),edges.newPieChart({id:"by_continent",dataFunction:scoss.continentDF,renderer:edges.nvd3.newPieChartRenderer({valueFormat:d3.format(",d"),labelsOutside:!0,color:!1})})]})},newServiceProviderPageTemplate:function(e){return edges.instantiate(scoss.ServiceProviderPageTemplate,e,edges.newTemplate)},ServiceProviderPageTemplate:function(e){this.namespace="scoss-spp",this.draw=function(e){this.edge=e;var s=edges.css_classes(this.namespace,"container"),r=edges.css_classes(this.namespace,"progress_committed"),i=edges.css_classes(this.namespace,"progress_paid"),d=edges.css_classes(this.namespace,"progress_needed"),a=edges.css_classes(this.namespace,"country"),t=edges.css_classes(this.namespace,"continent"),o=edges.css_classes(this.namespace,"top-donors"),n=edges.css_classes(this.namespace,"all-donors"),c='<div class="'+s+'">                    <div class="row">                        <div class="col-md-2 col-md-offset-3"><div id="progress_committed" class="'+r+'"></div></div>                        <div class="col-md-2"><div id="progress_paid" class="'+i+'"></div></div>                        <div class="col-md-2"><div id="progress_needed" class="'+d+'"></div></div>                    </div>                    <div class="row"><div class="col-md-12"><div id="by_country" class="'+a+'"></div></div></div>                    <div class="row"><div class="col-md-12"><div id="by_continent" class="'+t+'"></div></div></div>                    <div class="row"><div class="col-md-12"><div id="top_donors" class="'+o+'"></div></div></div>                    <div class="row"><div class="col-md-12"><div id="all_donors" class="'+n+'"></div></div></div>                </div></div>';e.context.html(c)}}};
